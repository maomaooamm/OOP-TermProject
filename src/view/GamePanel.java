...
public class GamePanel extends JPanel {
    ...
    /*public GamePanel(Image launcherImage) {
        launcherImage = null;
        
        try {
            launcherImage = ImageIO.read(getClass().getResource("bg.jpg"));
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Error: Cannot open bg.jpg");
            System.exit(-1);
        }
    }*/    
    ...
    public void gameRender() {
        ...
        //g2.drawImage(launcherImage, 0, 0,width,height,null);
